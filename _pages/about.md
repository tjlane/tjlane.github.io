...
On the software side, along with a fantastic team I am building the [Reciprocal Space Station Consortium](https://rs-station.org). RSS aims to connect structural biology to the power of scientific computing and AI to enable structural biology to cross the single-structure frontier.

On the hardware side, [my team at DESY](https://pbio.cfel.de) is working on developing:
